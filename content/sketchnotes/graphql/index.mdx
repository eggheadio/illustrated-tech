...
<Link to="https://egghead.io/courses/graphql-query-language?rc=272bjb">

![Course illustration of a set of dictionary books with the word "schema" across them](./og-graphql-query-language.jpg)
...
<FullSketchnote coursename="GraphQL Query Language" courselink="https://egghead.io/courses/graphql-query-language?rc=272bjb">
