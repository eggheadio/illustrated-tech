...
![Prototypes are how we do inheritance in JS. They're linked objects of parents and children that pass down inherited properties. All JS objects are made from a default prototye that includes the __proto__ property](./AdvancedJS_3@2x.png)

![.prototype is different to __proto__. It's a method on a function that points to a constructor object.](./AdvancedJS_5.png)

<br />

![The this keyword points to an object based on the execution cotext of where a function is called, not where it's defined.](./AdvancedJS_4@2x.png)
