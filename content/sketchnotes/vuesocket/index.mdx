...
But I got a tiny window of insight into the magic this week while sketching notes for [Mark Barton's new course](https://egghead.io/courses/vue-and-socket-io-for-real-time-communication) on building an instant chat app with [Vue.js](https://vuejs.org/) and [Socket.io](https://socket.io/).
