...
<p>Vue-Router (target) is an underground railway system with trains carriages travelling along it (source). Each pages in a Vue application is a station. The user clicking between pages is riding the train between stations. Building new routes between pages in laying down new train tracks and between stations</p>
</span>
...
I know this is a little like telling a joke, and then explaining why the joke was funny. It kind of sucks the fun out of it.  But breaking down the metaphors behind visuals is one of the best ways of getting better at thinking in them. 
...
There are plenty of editorial illustrators who are masterful at this. Two of my favourites are <Link to="https://www.emilianoponzi.com/">Emiliano Ponzi</Link> and <Link to="https://chasematt.com/">Matt Chase</Link>. Take a look at a few of their creations:
...
A challenge (target) is a maze (source). Following the traditional rules (target) is getting to the centre of a maze by walking between the hedges (source). Improvisation (target) is getting to the center by mowing a path through the hedges (source).
</Feature>

We're backwards engineering how the image works. It helps you stop operating on autopilot when you look at them, and understand there's a logical process in moving from abstract idea to concrete visuals.
