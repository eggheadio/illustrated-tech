...
import ThreeImageGrid from '../../../src/components/mdx/ThreeImageGrid.js'
...
import ReadNext from '../../../src/components/mdx/ReadNext.js'
...
If anyone is new to my website or work, here's the TLDR:
...
Here's a quick overview of what the course – it shows developers how to protect a website against common attacks like man-in-the-middle interceptions, cross-site scripting, and cookie hijacking. All your classic internet foes.
...
![Photos of a macbook pro, a cintiq drawing tablet, an ipad pro, and the app logos for procreate, illustrator, and photoshop](Techtools.png)
...
Funnily enough, it also fits our definition of a metaphor. ll of programming is giant stack of layered metaphors. <Tooltip tiptext={<span>Here's a terribly nerdy MIT PhD thesis about it if you want to go down the rabbit hole... <Link to="http://alumni.media.mit.edu/~mt/thesis/mt-thesis.html">Programming with Agents: New metaphors for thinking about computation</Link></span>}>6</Tooltip>

My point is that metaphor is native to programming.  This tower of abstractions move us further from machine world, and closer to human world.  

Illustrated metaphors that capture the main idea of a programming concept are one more layer on top of the human-friendly stack.
...
We'll cover how to do cultural and linguistic research to find existing metaphors. We'll also work through building new metaphors by focusing on core qualities of a concept, and using lateral thinking to generate alternative solutions.  Look out for it later this month.
...
<!-- 
<ReadNext title="Read Part 2" subtitle="How to do Cultural and Linguistic Research" /> -->