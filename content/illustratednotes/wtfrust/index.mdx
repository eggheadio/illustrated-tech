...
This happy balance Rust manages to strike – between speed, control over memory management, and human-friendliness is what makes it so popular.  
...
The Rust community is also infamous for being welcoming, open, and enouaging to newcomers. Fosting that kind of culture is very likely why it's gained so much traction in the last few years.
...
And no one wants to join a bunch judgey gatekeepers. 
...
I've just done a big picture overview of Rust here – enough to point you in the right direction. There's plenty more to explore.
...
Pascal covers more specific details like how Rust handles variables, mutability, functions, loops, and errors.

I also found plenty of useful articles and tutorials if you want to read more.
...
<FullNote verticalNote coursename="Write Your First Program with Rust" courselink="https://egghead.io/courses/write-your-first-program-with-the-rust-language?af=54fd64">
